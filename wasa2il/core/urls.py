...
urlpatterns = patterns('',
	...
	(r'^polity/(?P<polity__pk>\d+)/topic/$',			login_required(ListView.as_view(model=Topic, context_object_name="topics"))),
	...
	(r'^polity/(?P<polity__pk>\d+)/issue/$',			login_required(ListView.as_view(model=Issue, context_object_name="issues"))),
