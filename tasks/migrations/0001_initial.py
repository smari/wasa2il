# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-01-18 20:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.IntegerField(verbose_name=b'tasks.TaskSkills')),
        ...
        migrations.AddField(
            model_name='task',
            name='categories',
            field=models.ManyToManyField(to='tasks.TaskCategories'),
        ),
        migrations.AddField(
            model_name='task',
            name='created_by',
